...
public class AdditionalRegistry {
    ...
    public static final RegistryObject<Item> DEPTH_METER_ITEM = ITEMS.register("depth_meter", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
    ...
    public static final RegistryObject<Item> ROSE_GOLD_HELMET = ITEMS.register("rose_gold_helmet", () -> new ArmorItem(ROSE_GOLD_ARMOR_MATERIAL, EquipmentSlot.HEAD, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<Item> ROSE_GOLD_CHESTPLATE = ITEMS.register("rose_gold_chestplate", () -> new ArmorItem(ROSE_GOLD_ARMOR_MATERIAL, EquipmentSlot.CHEST, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<Item> ROSE_GOLD_LEGGINGS = ITEMS.register("rose_gold_leggings", () -> new ArmorItem(ROSE_GOLD_ARMOR_MATERIAL, EquipmentSlot.LEGS, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<Item> ROSE_GOLD_BOOTS = ITEMS.register("rose_gold_boots", () -> new ArmorItem(ROSE_GOLD_ARMOR_MATERIAL, EquipmentSlot.FEET, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    public static final RegistryObject<Item> GILDED_NETHERITE_HELMET = ITEMS.register("gilded_netherite_helmet", () -> new ArmorItem(GILDED_NETHERITE_ARMOR_MATERIAL, EquipmentSlot.HEAD, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).fireResistant()));
    public static final RegistryObject<Item> GILDED_NETHERITE_CHESTPLATE = ITEMS.register("gilded_netherite_chestplate", () -> new ArmorItem(GILDED_NETHERITE_ARMOR_MATERIAL, EquipmentSlot.CHEST, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).fireResistant()));
    public static final RegistryObject<Item> GILDED_NETHERITE_LEGGINGS = ITEMS.register("gilded_netherite_leggings", () -> new ArmorItem(GILDED_NETHERITE_ARMOR_MATERIAL, EquipmentSlot.LEGS, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).fireResistant()));
    public static final RegistryObject<Item> GILDED_NETHERITE_BOOTS = ITEMS.register("gilded_netherite_boots", () -> new ArmorItem(GILDED_NETHERITE_ARMOR_MATERIAL, EquipmentSlot.FEET, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).fireResistant()));

    // Tools
    public static final RegistryObject<Item> ROSE_GOLD_SWORD = ITEMS.register("rose_gold_sword", () -> new SwordItem(RoseGoldToolMaterial.MATERIAL, 4, -2.4F, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT)));
    ...
    public static final RegistryObject<Item> ROSE_GOLD_SHOVEL = ITEMS.register("rose_gold_shovel", () -> new ShovelItem(RoseGoldToolMaterial.MATERIAL, 1.5F, -3F, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
    ...
    public static final RegistryObject<Item> GILDED_NETHERITE_SWORD = ITEMS.register("gilded_netherite_sword", () -> new SwordItem(GildedNetheriteToolMaterial.MATERIAL, 5, -2.4F, new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).fireResistant()));
    ...
    public static final RegistryObject<Item> GILDED_NETHERITE_SHOVEL = ITEMS.register("gilded_netherite_shovel", () -> new ShovelItem(GildedNetheriteToolMaterial.MATERIAL, 3.5F, -3F, new Item.Properties().tab(CreativeModeTab.TAB_TOOLS).fireResistant()));
    ...
    public static final RegistryObject<Block> ROPE_BLOCK = BLOCKS.register("rope", () -> new RopeBlock(BlockBehaviour.Properties.of(Material.BAMBOO).noCollission().sound(SoundType.WOOL)));
    public static final RegistryObject<Block> COPPER_PATINA = BLOCKS.register("copper_patina", () -> new CopperPatinaBlock(BlockBehaviour.Properties.of(Material.CLOTH_DECORATION).noCollission().sound(SoundType.TUFF)));
    ...
    // Block Items
    public static final RegistryObject<Item> COPPER_PATINA_ITEM = ITEMS.register("copper_patina", () -> new BlockItem(COPPER_PATINA.get(), new Item.Properties().tab(CreativeModeTab.TAB_REDSTONE)));
    ...
    // Music Disc Items
    public static final RegistryObject<Item> MUSIC_DISC_0308 = ITEMS.register("music_disc_0308", () -> new AdditionalMusicDiscItem(5, U_SOUND_EVENT_0308, new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<Item> MUSIC_DISC_1007 = ITEMS.register("music_disc_1007", () -> new AdditionalMusicDiscItem(7, U_SOUND_EVENT_1007, new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<Item> MUSIC_DISC_1507 = ITEMS.register("music_disc_1507", () -> new AdditionalMusicDiscItem(6, U_SOUND_EVENT_1507, new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(1).rarity(Rarity.RARE)));
